...
(3.11). See [LANGUAGES.md](../../../../LANGUAGES.md) §3.
...
74 shared cases run identically on both sides. If a binding drifts — accepts something the other
rejects — its build fails naming the exact case. Adding a case to the JSON automatically holds every
binding to it.
